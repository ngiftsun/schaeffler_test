...
def build_regression(data,id):
    # get file name
    # Load file as array: 
    data = reject_outliers(data,ax=0,index=id, m = 2.5) 
    ...
    with open('linear_regression_3.pickle','wb') as f:
        pickle.dump(clf, f)
